namespace _01_Methodlar
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //geriye değer döndürmeyen ifadesi , methodun gövdesi yani method tanımlarken hangi türde olacağını söylemediğimiz methodlar için kullanılır.
            ...
            //parametrealmayanegeriyedegerdondurmeyenMethod();

            //bir parametre alan ve geriye değer döndürmeyen method tetikleme yöntemi
            //bırparametrealangeriyedegerdöndürmeyenMethod(10);
            ...
            //methodun gövdesi hangi türde ise return ifadesi kullanılarak gövdedeki tür ne ise returnde aynı tip verilir
            //yani gövede string ise return""; olmak zorunda!
